...
(function () {
    ...
    function AboutAboutContent() {
        ...
        let mysentence = "Its a new sentence altogather";
        pranew.textContent = mysentence;

    }
    // Code for project Details and Vaules
    ...
    let mytext = "Project Details"
        ...
        if(  document.getElementById("abc")){
            document.getElementById("abc").innerHTML = mytext;
        }
        if(  document.getElementById("abc1")){
            document.getElementById("abc1").innerHTML = mytext;
        }
        if(  document.getElementById("abc2")){
            document.getElementById("abc2").innerHTML = mytext;
        }

 // Project Page h6 Section
     myProject1= "<strong>Solutions:</strong> <br>The website facilitates the dealership’s business by making information about their inventory and prices readily available to customers..";
    ...
    myProject4 = " <strong>Solutions:</strong> <br>The reservation system helps minimize human errors and greatly facilitates hotel business by making reservations more efficient and cost-effective. .";
    ...
    myProject4 = "<strong>Solutions:</strong> <br> This project enabled me to give back to my community and add to the beauty of my surroundings  ";
